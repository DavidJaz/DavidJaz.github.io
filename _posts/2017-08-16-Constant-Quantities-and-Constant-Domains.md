...
**Proof:** If $$C$$ is constant, then the terminal map $$! : C \to 1$$ is monic since it varies over a constant domain. If $$C$$ is subterminal, then $$! : C \to 1$$ is a monic constant, so $$C$$ is constant. $$\square$$
